  ...
  return (
    <div className="space-y-6 w-full max-w-full overflow-x-hidden">
      ...
      {currentTab === 'demonstracao' ? (
        <div className="space-y-6 animate-fade-in">
          <div className="p-4 bg-purple-50 border border-purple-200 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-purple-950">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-sm font-bold">Ambiente de Demonstração Guiada do Administrador</h4>
                <p className="text-xs text-purple-700">
                  Acesse qualquer perfil para demonstrar as telas. Em qualquer perfil acessado, haverá um botão no topo para <strong>retornar instantaneamente a este acesso DEV</strong>.
                </p>
              </div>
            </div>
            <button
              onClick={() => handleSelectTab('empresas')}
              className="px-3 py-1.5 rounded-xl border border-purple-300 text-purple-800 bg-white hover:bg-purple-100 text-xs font-bold transition shrink-0 cursor-pointer"
            >
        ...
        <>
      {/* Top Banner Notice */}
      <div className="bg-purple-900/10 border border-purple-200 rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-purple-900">
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-xl bg-purple-600 text-white shrink-0">
            <ShieldCheck className="w-5 h-5" />
          </div>
          <div>
            <h4 className="text-sm font-bold">Painel Global de Administração (DEV)</h4>
            <p className="text-xs text-purple-700">
              Controle de empresas clientes e tenants. Conforme a regra de isolamento multi-tenant, operações internas são restritas à empresa ou acessíveis via modo demonstração.
            </p>
          </div>
        </div>

        <button
          onClick={() => switchDemoRole('EMPRESA')}
          className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-purple-600 hover:bg-purple-700 text-white text-xs font-bold transition shadow-sm shrink-0"
        >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-xs">
          ...
          <div className="text-[11px] text-slate-400 mt-1">{activeCompanies} ativas no sistema</div>
        </div>

        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-xs">
          <div className="text-xs font-semibold text-emerald-600 uppercase tracking-wider">Empresas Ativas</div>
          <div className="text-2xl font-black text-emerald-600 mt-1">{activeCompanies}</div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-xs">
          ...
          <div className="text-2xl font-black text-purple-600 mt-1">{totalDevs}</div>
          <div className="text-[11px] text-slate-400 mt-1">Acesso administrativo global</div>
        </div>

        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-xs">
          <div className="text-xs font-semibold text-blue-600 uppercase tracking-wider">Devs Ativos</div>
          <div className="text-2xl font-black text-blue-600 mt-1">{activeDevs}</div>
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-3 py-1.5 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:border-blue-500 w-44 sm:w-52"
              />
            </div>
            ...
            {/* Action buttons: Cadastrar Empresa & Cadastrar Dev */}
            <button
              onClick={handleOpenCreateCompany}
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold transition shadow-sm shrink-0 cursor-pointer"
            >
              <Building2 className="w-3.5 h-3.5" />
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-purple-600 hover:bg-purple-700 text-white text-xs font-bold transition shadow-sm shrink-0 cursor-pointer"
            >
              <ShieldCheck className="w-3.5 h-3.5" />
